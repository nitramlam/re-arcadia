...
-- Table des avis (liée à utilisateurs)
CREATE TABLE `AVIS` (
...
-- Table des animaux (liée à habitat)
CREATE TABLE `animal` (
...
-- Insertions minimales pour le fonctionnement
INSERT INTO `utilisateurs` (`email`, `password`, `role`) VALUES
('employearcadia33@gmail.com', '$2a$12$2YNwNb2kLBtv/uDDqqXZuOVKgcvEjZ0D9066Nk3mHC8TzBQIgwidu', 'employe'),
('josearcadia33@gmail.com', '$2a$12$adN4kCf9XtBjPmLKMNJNzOoOX.RKAxkWzDHkEHFCFC16uP8ktrv6y', 'administrateur'),
('veterinairearcadia@gmail.com', '$2a$12$4.cMG/B0YCQ8tXN3F/kSKeqS2IdjNmigjgqn4CXAIJpN.eV9fDF4y', 'veterinaire');
