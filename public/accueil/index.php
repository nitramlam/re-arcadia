...
<body>
    ...
    <main>
        ...
        <div class="services">
            ...
            <p class="servicesLorem">Découvrez notre restaurant, notre petit train et bénéficiez d'un guide gratuit pour
                enrichir votre expérience au Zoo Écologique de la Forêt de Brocéliande.</p>
            <img class="autruche" src="assets/autruche-accueil.png" alt="autruche">
            <a href="/services/index.php" class="flecheServices"> <img src="assets/fleches-accueil.png"
                    alt="Fleche pour voir les animaux"></a>
        ...
        <div class="grid-section">
            ...
            <div class="gridHabitats">
                ...
                <p class="loremHabitats">Explorez notre variété d'animaux dans des habitats reconstitués : la jungle
                    luxuriante, les marais préservés et la savane durablement aménagée.</p>
                <img class="toucan" src="assets/toucan-accueil.png" alt="Image d'un toucan">
                <a href="/habitats/index.php" class="flecheHabitats"><img src="assets/fleches-accueil.png"
                        alt="Fleche pour voir les habitats"></a>
            </div>
            <div class="gridAnimaux">
                <h3 class="animauxTitre">LES ANIMAUX</h3>
                <p class="animauxLorem">Rencontrez nos résidents exceptionnels, élevés dans un environnement respectueux
                    de leur bien-être et de la nature.</p>
                <img class="paresseux" src="assets/paresseux-accueil.png" alt="Image d'un paresseux">
                <a href="/animaux/index.php" class="flecheAnimaux"><img src="assets/fleches-accueil.png"
                        alt="Fleche pour voir les animaux"></a>
            </div>
            <div class="gridImage">
